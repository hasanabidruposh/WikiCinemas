...
<div class="w3-col w3-container" style="float:left; width:23%; height:750px; background-color:#f1f1f1;border:2px solid #000000;">
...
<p><strong>Tickets sold:</strong> <?php echo $sold; ?></p>

</div>
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">

<button type="submit" style="background-color:#FFFFFF;" name="delete_show" value="<?php echo $id; ?>" >Cancel Show</button></form>
</div>
