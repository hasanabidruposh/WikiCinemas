...
<body>
   ...
   <h1 style="float:left; border:5px solid; border-color:#333333; padding:10px; width:auto"><img src="love.PNG" style="float:left;width:70px;height:60px;"> <div style="width:250px; padding-top:20px">iki Cinemas</div></h1>
...
<form action="home.php" style="width:50%; margin:auto; background-color:#f1f1f1;border:10px solid #f1f1f1" method="post">
